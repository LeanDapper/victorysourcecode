...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, gameVer +  " FNF - " + kadeEngineVer + " Kade Engine  " + "Original Mod and certain Assets by Team Funktastic" , 12);
	...
	function goToState()
	{
		...
		switch (daChoice)
		{
			case 'victory':
				...
				PlayState.SONG = Song.conversionChecks(Song.loadFromJson(PlayState.storyPlaylist[0], PlayState.storyPlaylist[0]));
